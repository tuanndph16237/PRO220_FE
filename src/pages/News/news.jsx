...
<div className="container">
	<div className="mainheading">
		<h1 className="sitetitle">Tin tức về Dodoris</h1>
		<p className="lead">
		sửa & bảo dưỡng xe
		</p>
	</div>
	...
	<div className="section-title">
		<h2><span>dodoris chính thức hỗ trợ sửa xe vinfast </span></h2>
	</div>
				...
				<div className="col-md-5 wrapthumbnail">
					<a href="#">
						<div className="thumbnail1">
							<img src="../../../public/images/dongson_1656870190_1658394873.png" alt="" />
						</div>
					</a>
				</div>
				<div className="col-md-7">
					<div className="card-block">
						<h2 className="card-title"><a href="#">từ ngày 24/12/2022 dodoris hợp tác với vinfast triển khai dịch vụ sửa tất cả các ô tô của Vinfast </a></h2>
						<h4 className="card-text">, với phụ tùng thay thế chính hãng và không thu thêm bất cứ khoản phí trung gian nào</h4>
			...
			<div className="row">
				<div className="col-md-5 wrapthumbnail">
					<a href="#">
						...
						<img src="../../../public/images/khongbaohanh_1656867978_1658395966.png" alt="" />
						</div>
					</a>
				</div>
				<div className="col-md-7">
				...
				<div className="col-md-5 wrapthumbnail">
					<a href="#">
						<div className="thumbnail3" >
							<img src="../../../public/images/pvbaohanh2_1656867652_1658395746.png" alt="" />
						</div>
					</a>
				</div>
				<div className="col-md-7">
				...
				<div className="col-md-5 wrapthumbnail">
					<a href="#">
						<div className="thumbnail4" >
							<img src="../../../public/images/pvbaohanh_1656867638_1658395738.png" alt="" />
						</div>
					</a>
				</div>
				<div className="col-md-7">
					<div className="card-block">
						...
						<div className="metafooter">
							<div className="wrapfooter">
								<span className="meta-footer-thumb">
								<a href="#"><img className="author-thumb" src="https://storage.googleapis.com/vinfast-data-01/canchinhbanhxe_1656870278_1658394988.png" alt="Sal"/></a>
								</span>
								<span className="author-meta">
								<span className="post-name"><a href="#">Sal</a></span><br/>
								<span className="post-date">22 July 2017</span><span className="dot"></span><span className="post-read">6 min read</span>
								</span>
								<span className="post-read-more"><a href="#" title="Read Story"><svg className="svgIcon-use" width="25" height="25" viewBox="0 0 25 25"><path d="M19 6c0-1.1-.9-2-2-2H8c-1.1 0-2 .9-2 2v14.66h.012c.01.103.045.204.12.285a.5.5 0 0 0 .706.03L12.5 16.85l5.662 4.126a.508.508 0 0 0 .708-.03.5.5 0 0 0 .118-.285H19V6zm-6.838 9.97L7 19.636V6c0-.55.45-1 1-1h9c.55 0 1 .45 1 1v13.637l-5.162-3.668a.49.49 0 0 0-.676 0z" fillRule="evenodd"></path></svg></a></span>
							</div>
		...
		<div className="card">
			...
			<div className="card-block">
				...
				<div className="metafooter">
					<div className="wrapfooter">
						<span className="meta-footer-thumb">
						<a href="#"><img className="author-thumb" src="../../../public/images/logo.png" alt="Sal"/></a>
						</span>
						<span className="author-meta">
						<span className="post-name"><a href="#">Sal</a></span><br/>
						<span className="post-date">22 July 2017</span><span className="dot"></span><span className="post-read">6 min read</span>
		...
		<div className="card">
			...
			<div className="card-block">
				...
				<div className="metafooter">
					<div className="wrapfooter">
						<span className="meta-footer-thumb">
						<a href="#"><img className="author-thumb" src="../../../public/images/mylogo.png" alt="Sal"/></a>
						</span>
						<span className="author-meta">
						<span className="post-name"><a href="#">Sal</a></span><br/>
						<span className="post-date">22 July 2017</span><span className="dot"></span><span className="post-read">6 min read</span>
		...
		<div className="card">
			...
			<div className="card-block">
				...
				<div className="metafooter">
					<div className="wrapfooter">
						<span className="meta-footer-thumb">
						<a href="#"><img className="author-thumb" src="../../../public/images/facebook.png" alt="Sal"/></a>
						</span>
						<span className="author-meta">
						<span className="post-name"><a href="#">Sal</a></span><br/>
						<span className="post-date">22 July 2017</span><span className="dot"></span><span className="post-read">6 min read</span>
		...
		<div className="card">
			...
			<div className="card-block">
				...
				<div className="metafooter">
					<div className="wrapfooter">
						<span className="meta-footer-thumb">
						<a href="#"><img className="author-thumb" src="../../../public/images/zalo.png" alt="Sal"/></a>
						</span>
						<span className="author-meta">
						<span className="post-name"><a href="#">Sal</a></span><br/>
						<span className="post-date">22 July 2017</span><span className="dot"></span><span className="post-read">6 min read</span>
		...
		<div className="card">
			...
			<div className="card-block">
				...
				<div className="metafooter">
					<div className="wrapfooter">
						<span className="meta-footer-thumb">
						<a href="#"><img className="author-thumb" src="../../../public/images/youtube.png" alt="Sal"/></a>
						</span>
						<span className="author-meta">
						<span className="post-name"><a href="#">Sal</a></span><br/>
						<span className="post-date">22 July 2017</span><span className="dot"></span><span className="post-read">6 min read</span>
		...
		<div className="card">
			...
			<div className="card-block">
				...
				<div className="metafooter">
					<div className="wrapfooter">
						<span className="meta-footer-thumb">
						<a href="#"><img className="author-thumb" src="../../../public/images/admin-logo.png"/></a>
						</span>
						<span className="author-meta">
						<span className="post-name"><a href="#">Sal</a></span><br/>
						<span className="post-date">22 July 2017</span><span className="dot"></span><span className="post-read">6 min read</span>
